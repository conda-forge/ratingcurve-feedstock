...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ratingcurve-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ratingcurve-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ratingcurve
# for installing globally
pixi global install ratingcurve
```
...
It is possible to list all of the versions of `ratingcurve` available on your platform:
...
```
pixi search ratingcurve --channel conda-forge
```
